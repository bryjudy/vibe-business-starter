...
const STARTER_PROMPT = `I'm working with an Vibe Business Starter project that includes authentication, database integration, and AI capabilities. Here's what's already set up:

## Current Vibe Business Starter Structure
...
## Important Context
This is an **Vibe Business Starter/starter template** - all existing pages and components are meant to be examples and should be **completely replaced** to build the actual AI-powered application.

### CRITICAL: You MUST Override All Starter Content
**DO NOT keep any starter components, text, or UI elements unless explicitly requested.** This includes:

- **Remove all placeholder/demo content** (setup checklists, welcome messages, starter text)
...
3. **No Hybrid Approach**: Don't try to integrate new features alongside existing starter content
4. **Clean Slate**: The final application should have NO trace of the original starter UI or content
...
## Request
Please help me transform this starter into my actual application. **You MUST completely replace all existing starter code** to match my project requirements. The current implementation is just temporary scaffolding that should be entirely removed and replaced.

## Final Reminder: COMPLETE REPLACEMENT REQUIRED
**⚠️ IMPORTANT**: Do not preserve any of the existing starter UI, components, or content. The user expects a completely fresh application that implements their requirements from scratch. Any remnants of the original starter (like setup checklists, welcome screens, demo content, or placeholder navigation) indicate incomplete implementation.

**Success Criteria**: The final application should look and function as if it was built from scratch for the specific use case, with no evidence of the original starter template.
