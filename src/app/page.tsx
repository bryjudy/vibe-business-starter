...
import { Shield, Database, Palette, Bot, Rocket } from "lucide-react";
      ...
      <div className="max-w-4xl mx-auto text-center space-y-8">
        <div className="space-y-4">
          ...
          <h2 className="text-2xl font-semibold text-muted-foreground">
            Build AI-Powered Business Apps Fast
          </h2>
          <p className="text-xl text-muted-foreground">
            A full-stack starter with authentication, database, AI integration,
            and modern tooling — everything you need to ship your next business
            application
          </p>
        </div>
